...
export default function EarningsTracker() {
  ...
  const loadData = () => {
    ...
    const productionData = loadFromStorage("production", [])
  ...
  const handleAddEarnings = (e: React.FormEvent) => {
    ...
    saveToStorage("earnings", updatedEarnings)
  ...
  const handleAddProduction = (e: React.FormEvent) => {
    ...
    saveToStorage("production", updatedProduction)

    // If selling immediately, create earnings record
        ...
        <Card className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border-white/20 dark:border-gray-600/20 shadow-lg hover:shadow-xl transition-all duration-300">
          ...
          <CardContent>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              {dateFilter === "all" ? "All time" : `${dateFilter} period`}
            </p>
          </CardContent>
        </Card>
          ...
          <CardTitle className="flex items-center justify-between">
            ...
            <div className="flex space-x-2">
              ...
              <Dialog open={addEarningsOpen} onOpenChange={setAddEarningsOpen}>
                ...
                <DialogContent className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-md border-white/20 dark:border-gray-600/20">
                  <DialogHeader>
                  ...
                  <form onSubmit={handleAddEarnings} className="space-y-4">
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value: any) => setEarningsForm({ ...earningsForm, type: value })}
                      >
                        <SelectTrigger className="bg-white/50 dark:bg-gray-700/50 border-gray-300 dark:border-gray-600">
                          <SelectValue />
                        </SelectTrigger>
                  ...
                  >
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                        ...
                        {earning.saleType && ` • ${earning.saleType.replace("_", " ")}`}
                        {earning.buyerName && ` • Buyer: ${earning.buyerName}`}
                      </p>
                      {earning.notes && (
