...
// Generate sequential rabbit IDs based on farm name
export function generateRabbitId(farmId: string): string {
  const tempFarm = localStorage.getItem('rabbit_farm_data') ?? '';
